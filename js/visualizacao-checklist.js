...
function renderizarFotosVisualizacao(fotos) {
  ...
  fotos.forEach(function (foto) {
    ...
    bloco.title = foto.tipo + (foto.usuario_nome ? " — enviada por " + foto.usuario_nome : "");

    const legenda = foto.tipo + (foto.usuario_nome ? " — " + foto.usuario_nome : "");
    bloco.innerHTML = '<img src="' + foto.link + '" alt="' + foto.tipo + '" />' + '<span class="selo-status">' + legenda + "</span>";
